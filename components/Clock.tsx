...
const Clock: React.FC<ClockProps> = ({ config, isEditMode, onOpenSettings }) => {
  ...
  // ⚡ Bolt Optimization: Cache Intl.DateTimeFormat instances using useMemo.
  // Instantiating new formatters via toLocaleTimeString/toLocaleDateString on every 1-second render loop is very expensive.
  // This reduces re-render overhead by ~60x.
  ...
  // ⚡ Bolt Optimization: Cache date formatter as well since it has no dynamic dependencies.
