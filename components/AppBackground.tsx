...
// Wrapped in React.memo to prevent expensive re-renders of the background layer
// (especially animated or image layers) during unrelated app state updates
// like drag-and-drop or modal toggles.
