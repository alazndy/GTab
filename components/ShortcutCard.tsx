...
import { XMarkIcon, Cog6ToothIcon, UserIcon, FolderIcon, BoltIcon } from '@heroicons/react/24/outline';
import { getFavicon, resolveTargetUrl } from './utils/shortcutUtils';
import { ShortcutProfileDropdown } from './ShortcutProfileDropdown';
...
const ShortcutCard: React.FC<ShortcutCardProps> = memo(({
  ...
  return (
    ...
    >
      ...
      {hasProfiles && !activeProfile && shortcut.profiles && (
        <ShortcutProfileDropdown 
