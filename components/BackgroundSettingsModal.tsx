...
import { X, Check, Image, Palette, Shuffle, Link as LinkIcon } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-black/20">
          ...
          {activeTab === 'presets' && (
            <div className="space-y-6">
              ...
              >
                <Shuffle size={20} className={currentConfig.type === 'random' ? 'text-blue-400' : 'text-white/60'} />
                ...
                {currentConfig.type === 'random' && <Check className="ml-auto text-blue-400" size={20} />}
              </button>
