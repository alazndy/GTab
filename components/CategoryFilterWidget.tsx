...
export const CategoryFilterWidget: React.FC = () => {
  ...
  // ⚡ Bolt: Consolidated activeCategories and uniqueProfiles derivations into a single loop
  // to avoid multiple object allocations, .map, .flatMap and multiple iterations.
