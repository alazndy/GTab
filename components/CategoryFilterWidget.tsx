...
export const CategoryFilterWidget: React.FC = () => {
  ...
  // Consolidate iterations: Derive both categories and profiles in a single O(N) pass
  // to prevent multiple `.map` and `.flatMap` object allocations on large shortcut lists.
