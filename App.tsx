...
const App: React.FC = () => {
  ...
  // Memoizing these expensive array operations prevents redundant recalculations
  // on every render cycle, significantly improving performance as the shortcuts array grows.
