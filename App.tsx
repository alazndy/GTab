...
const App: React.FC = () => {
  ...
  // Bolt Optimization: Memoize expensive array operations (extracting categories, profiles, and filtering shortcuts).
  // Previously, these ran on every render loop inside renderWidgetContent.
  // Memoization reduces layout re-renders computation time, especially with larger lists of shortcuts.
